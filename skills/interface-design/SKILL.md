...
description: Interface craft for SaaS dashboards, admin panels, tools, and data-dense product UI. Use for AI Collector cabinet after ru-ai-collector-product-design. NOT for marketing landing pages — use frontend-design there.
---
...
- Always after `ru-ai-collector-product-design` for cabinet work.
- Prefer dense, operator-first layouts over generic KPI card grids.
- Risk / readiness / review outrank decorative dashboards.
- Russian labels go through `russian-product-copy`.
