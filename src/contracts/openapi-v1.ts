...
export const openApiV1 = {
  ...
  paths: {
    ...
    '/tenants/{tenantId}/campaigns/{campaignId}/debtors/{debtorRecordId}/calls/sandbox': { post: { operationId: 'startSandboxCall', parameters: [{ $ref: '#/components/parameters/TenantId' }, { $ref: '#/components/parameters/CampaignId' }, { $ref: '#/components/parameters/DebtorRecordId' }], responses: { '201': { description: 'Call started' }, '403': error, '409': error } } },
