...
- Дата: 2026-08-20
- Последняя закрытая: OP-D-004
- Следующая кандидат: OP-T-002
- Риски/договорённости: Force-stop UI сознательно не добавлен (ждёт OP-T-002); переход «останавливается…» — локальный UI на время PATCH.
- Инварианты: OP-D-001…004, OP-T-001.
